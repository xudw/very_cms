...
<div class="wy_top2">
 ...
 <li class="wy_top_one">
     ...
     <div class="news_c" style="border-top:2px solid #81b103;">
          <h1>sadf</h1>
          <div class="h1div"><span>来源:asdf</span><span>作者:sadf</span><span>时间:2015-07-31 10:05:00</span></div>
...
mso-font-kerning:0pt">
                <p><img alt="aa.png" src="/very_cms/ueditorimage/image/20150731/1438308689612557.png" title="1438308689612557.png"/></p>
          </div>
     ...
     <div class="pinlun_list" >
         <div class="game_comment" style="margin-bottom: 20px;">
             ...
             <ul id="comment_lst">
                ...
                <div style="font-size: 12px;">
                   <div></div><div style="float:right">2015-07-31 11:37:30</div>
                    <div style="clear:both;">什么呀			</div>
                </div>
                </li><li>
                <div style="font-size: 12px;">
                   <div></div><div style="float:right">2015-07-31 11:24:36</div>
                    <div style="clear:both;">哈哈哈哈			</div>
                </div>
                </li>
             </ul>
         </div>
         <form method="post" action="<?php echo WEB_NAME; ?>/index.php/SomeAction/comment">
            ...
            <input type="hidden" value="<?php echo WEB_NAME; ?>/index.php/Index/news/pid/3" name="pageurl">
