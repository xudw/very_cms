...
<div class="box_d">
     <div class="top_d">
         <span class="top_d_left"><a href="<?php echo WEB_NAME; ?>/index.php/Index/index/" target="_blank">首页</a></span>
  ...
  <div class="on_cent_left new_list">
          <div class="t_tit">
           ...
           <?php if(is_array($data)): foreach($data as $key=>$da): ?><dl>
                <img src="<?php echo ($da["newimage"]); ?>"/>
                <dt><a href="<?php echo WEB_NAME; ?>/index.php/Index/news/pid/<?php echo ($da["id"]); ?>"><?php echo ($da["title"]); ?></a></dt>
                 <dd><?php echo mb_substr($da['content'],0,50,'utf-8'); ?>...</dd>
                 <p><span>来源：<?php echo ($da["come"]); ?></span><span><?php echo ($da["time"]); ?></span></p>
