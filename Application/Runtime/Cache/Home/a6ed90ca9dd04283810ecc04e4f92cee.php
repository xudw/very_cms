...
<div class="box_center">
    ...
    <div class="ios_d_r">
          ...
          <div class="c2_phb" style=" margin-top:15px;">
            ...
            <ul>
             <li class="phb_top_one">
                    ...
                    <div class="phb_top_zi"><a href="<?php echo WEB_NAME; ?>/index.php/Index/product/pid/26" target="_blank" class="hei333">地方</a></div>
     ...
     <div class="cent1_left">
         <div class="c1_img"><img src="/very_cms/appimage/20150731/20150731212418aa.jpg" /></div>
         <h1>标签新闻1<span>阿道夫</span></h1>
         <div class="star_5"></div>
         <div class="c1_biaoqian"><span style="background-color:#cb1818;">单机</span><span>中文</span><span>否</span></div>
         <div class="c1_biaoqian2"><span>上线: 2015-07-31 21:24:18</span></div>
     ...
     <div class="left_jianjie">
         ...
         <div class="jianjie_cent">
            ...
            <p>标签新闻1标签新闻1标签新闻1标签新闻1标签新闻1标签新闻1标签新闻1标签新闻1标签新闻1标签新闻1标签新闻1标签新闻1标签新闻1标签新闻1标签新闻1标签新闻1标签新闻1标签新闻1<img alt="aa.jpg" src="/very_cms/ueditorimage/image/20150731/1438349056162531.jpg" title="1438349056162531.jpg"/></p>
        <br /></p>
         </div>
     </div>
         ...
         <div id="k_down">
               <ul>
				<li><input style="margin-top:20px;" class="a-upload" title="24" tag="萨芬"  id="down"  value="点击这里进行下载"></li>
    ...
    <div class="comm">
        ...
        <form method="post" action="<?php echo WEB_NAME; ?>/index.php/SomeAction/comment">
            ...
            <input type="hidden" value="<?php echo WEB_NAME; ?>/index.php/Index/product/pid/24" name="pageurl">
