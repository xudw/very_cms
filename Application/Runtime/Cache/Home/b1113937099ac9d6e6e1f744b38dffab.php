...
<div class="wy_top2">
 ...
 <li class="wy_top_one">
                ...
                <a href="<?php echo WEB_NAME; ?>/index.php/Index/product/pid/5" title="" target="_blank"> <img src="/very_cms/image/20150725/201507251819492.png" /></a>
                 <div class="wy_top_zi"><a href="<?php echo WEB_NAME; ?>/index.php/Index/product/pid/5" title="" target="_blank">测试游戏应用</a></div>
                 <p class="star1 wy_top_star"></p>
                 <p class="wy_top_zi2">w</p>
              </li> <li class="wy_top_one">
                 <div class="wy_top_bot1">2</div>
                <a href="<?php echo WEB_NAME; ?>/index.php/Index/product/pid/8" title="" target="_blank"> <img src="/very_cms/image/20150725/201507251819582.png" /></a>
                 <div class="wy_top_zi"><a href="<?php echo WEB_NAME; ?>/index.php/Index/product/pid/8" title="" target="_blank">测试游戏应用一</a></div>
                 <p class="star1 wy_top_star"></p>
                ...
                <a href="<?php echo WEB_NAME; ?>/index.php/Index/product/pid/9" title="" target="_blank"> <img src="/very_cms/image/20150725/201507251026042.png" /></a>
                 <div class="wy_top_zi"><a href="<?php echo WEB_NAME; ?>/index.php/Index/product/pid/9" title="" target="_blank">测试游戏应用二</a></div>
                 <p class="star1 wy_top_star"></p>
                 <p class="wy_top_zi2">qw</p>
              </li> <li class="wy_top_one">
                 <div class="wy_top_bot1">4</div>
                <a href="<?php echo WEB_NAME; ?>/index.php/Index/product/pid/10" title="" target="_blank"> <img src="/very_cms/image/20150725/201507251026322.png" /></a>
                 <div class="wy_top_zi"><a href="<?php echo WEB_NAME; ?>/index.php/Index/product/pid/10" title="" target="_blank">测试游戏应三</a></div>
                 <p class="star1 wy_top_star"></p>
                 <p class="wy_top_zi2">adf</p>
              </li> <li class="wy_top_one">
                 <div class="wy_top_bot1">5</div>
                <a href="<?php echo WEB_NAME; ?>/index.php/Index/product/pid/11" title="" target="_blank"> <img src="/very_cms/image/20150725/201507251026542.png" /></a>
                 <div class="wy_top_zi"><a href="<?php echo WEB_NAME; ?>/index.php/Index/product/pid/11" title="" target="_blank">测试游戏应用四</a></div>
                 <p class="star1 wy_top_star"></p>
                 <p class="wy_top_zi2">sdf</p>
              </li> <li class="wy_top_one">
                 <div class="wy_top_bot1">6</div>
                <a href="<?php echo WEB_NAME; ?>/index.php/Index/product/pid/12" title="" target="_blank"> <img src="/very_cms/appimage/20150726/201507261149002.png" /></a>
                 <div class="wy_top_zi"><a href="<?php echo WEB_NAME; ?>/index.php/Index/product/pid/12" title="" target="_blank">测试游戏应用五</a></div>
                 <p class="star1 wy_top_star"></p>
                 <p class="wy_top_zi2">sdf</p>
              </li>
		          </ul>
     ...
     <div class="news_c" style="border-top:2px solid #81b103;">
          <h1>测试新闻测试新闻测试新闻测试新闻</h1>
          <div class="h1div"><span>来源:sdf</span><span>作者:sadf</span><span>时间:0000-00-00 00:00:00</span></div>
