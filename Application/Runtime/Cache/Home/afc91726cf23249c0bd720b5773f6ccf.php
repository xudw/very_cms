...
<div class="box_rank">
                          ...
                          <div class="t_tit" id="t_tit">
                              <ul class="t_left_ul">
                                  <li ><a href="<?php echo WEB_NAME; ?>/index.php/Index/paihang/type/android">æ¸¸æˆä¸‹è½½æ’è¡Œæ¦œ</a></li>
                                  <li class="t_tit_li">ç½‘æ¸¸ä¸‹è½½æ’è¡Œæ¦œ</li>
                              </ul>
                          </div>
                          <div class="jietus showNow">
                                      <dl>
                                 <div class="rank_nab">1</div>
                                 <a href="" target="_blank"><img src="/very_cms/appimage/20150729/201507292241152.png"  /></a>
                                 <dt><a href="<?php echo WEB_NAME; ?>/index.php/Index/product/pid/" target="_blank">dsfg</a></dt>
                                 <dd>ä¸‹è½½:0 </dd>
                                 <dd>2015-07-29 22:41:15</dd>
                              </dl>
                                 </div>
