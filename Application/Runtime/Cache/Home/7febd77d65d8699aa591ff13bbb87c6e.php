...
<div class="box_center">
    ...
    <div class="ios_d_r">
     ...
     <div class="cent1_left">
         <div class="c1_img"><img src="/very_cms/appimage/20150731/20150731212337aa.jpg" /></div>
         <h1>标签游戏<span>2.2</span></h1>
         <div class="star_5"></div>
         <div class="c1_biaoqian"><span style="background-color:#cb1818;">单机</span><span>中文</span><span>否</span></div>
         <div class="c1_biaoqian2"><span>上线: 2015-07-31 21:23:37</span></div>
     ...
     <div class="left_jianjie">
         ...
         <div class="jianjie_cent">
            ...
            <p>标签游戏标签游戏标签游戏标签游戏标签游戏标签游戏标签游戏标签游戏标签游戏标签游戏标签游戏标签游戏标签游戏标签游戏标签游戏<img alt="aa.jpg" src="/very_cms/ueditorimage/image/20150731/1438349015123152.jpg" title="1438349015123152.jpg"/></p>
        <br /></p>
         </div>
     </div>
         ...
         <div id="k_down">
               <ul>
				<li><input style="margin-top:20px;" class="a-upload" title="23" tag="是是是"  id="down"  value="点击这里进行下载"></li>
    ...
    <div class="comm">
        ...
        <form method="post" action="<?php echo WEB_NAME; ?>/index.php/SomeAction/comment">
            ...
            <input type="hidden" value="<?php echo WEB_NAME; ?>/index.php/Index/product/pid/23" name="pageurl">
