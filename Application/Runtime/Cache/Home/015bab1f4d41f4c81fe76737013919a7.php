...
<div class="box_menu2">
     ...
     <div class="menu">
         ...
         <a href="<?php echo WEB_NAME; ?>/index.php/Index/appshow/type/html5" target="_blank" class="menu_bg5">HTML5</a>
...
<div class="box_mulu">
     <ul>
         ...
         <li><span class="mulu_bg4">HTML5</span>
            <a href="<?php echo WEB_NAME; ?>/index.php/Index/product/pid/25"   target="_blank">这个是html</a>
				</li>
     </ul>
</div>
<!--serach -->
<div class="box_sou">
     ...
     <div class="sou_zi"><span>热门搜索</span>
         <a href="<?php echo WEB_NAME; ?>/index.php/Index/product/pid/20"   target="_blank">一个测试应用</a><a href="<?php echo WEB_NAME; ?>/index.php/Index/product/pid/21"   target="_blank">第二个测试应用</a><a href="<?php echo WEB_NAME; ?>/index.php/Index/product/pid/22"   target="_blank">苹果</a><a href="<?php echo WEB_NAME; ?>/index.php/Index/product/pid/25"   target="_blank">这个是html</a>
		</div>
</div>
<!--bamner -->
<div class="box_cent1">
     ...
     <div class="c1_news">
          <div class="wy_news_tit">
             <h1><a target="_blank" href="<?php echo WEB_NAME; ?>/index.php/Index/news/pid/8" title="这个是首页头条" class="red">这个是首页头条</a></h1>
             <!-- <p><a href="" title=""  target='_blank'>[剑仙缘]</a><ahref="" title=""  target='_blank'>[诛神online-五岳争霸]</a><a href="" title=""  target='_blank'>[时空猎人]</a></p> -->
          </div>
          <ul>
		          <li><a target="_blank" href="<?php echo WEB_NAME; ?>/index.php/Index/news/pid/9"  title="首页的新闻首页的新闻首页的新闻首页的新闻">首页的新闻首页的新闻首页的新闻首页的新闻</a></li>
		          </ul>
     </div>
</div>
<!--cent2 -->
...
<div class="box_cent4">
     ...
     <div class="c2_ceshibiao">
          ...
          <ul class="c2_phb">
            ...
            <div class="phb_top_bot1">1</div>
             ...
             <li class="phb_top_two"><div class="phb_top_bot1">2</div><a target="_blank" href="<?php echo WEB_NAME; ?>/index.php/Index/product/pid/21">第二个测试应用</a><span>音乐</span></li> <li class="phb_top_two"><div class="phb_top_bot1">3</div><a target="_blank" href="<?php echo WEB_NAME; ?>/index.php/Index/product/pid/24">标签新闻1</a><span>阿萨德发</span></li> <li class="phb_top_two"><div class="phb_top_bot1">4</div><a target="_blank" href="<?php echo WEB_NAME; ?>/index.php/Index/product/pid/23">标签游戏</a><span>没有</span></li>
     ...
     <div class="wy_zixun">
          ...
          <ul class="hd_ul">
                      <li><a href="<?php echo WEB_NAME; ?>/index.php/Index/news/pid/8" target="_blank">这个是首页头条</a></li><li><a href="<?php echo WEB_NAME; ?>/index.php/Index/news/pid/7" target="_blank">这个是子夜的头条</a></li>
