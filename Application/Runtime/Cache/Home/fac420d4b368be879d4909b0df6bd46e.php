...
<div class="box_mulu">
     <ul>
         <li><span class="mulu_bg1">安卓</span>
		        <a href="<?php echo WEB_NAME; ?>/Home/index.php/Index/product/pid/5"   target="_blank">测试游戏应用</a><a href="<?php echo WEB_NAME; ?>/Home/index.php/Index/product/pid/8"   target="_blank">测试游戏应用一</a>
				</li>
         <li><span class="mulu_bg2">苹果</span>
		         <a href="<?php echo WEB_NAME; ?>/Home/index.php/Index/product/pid/9"   target="_blank">测试游戏应用二</a>
				</li>
         <li><span class="mulu_bg3">wp</span>
            <a href="<?php echo WEB_NAME; ?>/Home/index.php/Index/product/pid/10"   target="_blank">测试游戏应三</a>
				</li>
...
<div class="box_sou">
     ...
     <div class="sou_zi"><span>热门搜索</span>
         <a href="<?php echo WEB_NAME; ?>/Home/index.php/Index/product/pid/5"   target="_blank">测试游戏应用</a><a href="<?php echo WEB_NAME; ?>/Home/index.php/Index/product/pid/8"   target="_blank">测试游戏应用一</a><a href="<?php echo WEB_NAME; ?>/Home/index.php/Index/product/pid/9"   target="_blank">测试游戏应用二</a><a href="<?php echo WEB_NAME; ?>/Home/index.php/Index/product/pid/10"   target="_blank">测试游戏应三</a>
		</div>
</div>
<!--bamner -->
<div class="box_cent1">
     ...
     <div class="c1_news">
          <div class="wy_news_tit">
             <h1><a target="_blank" href="<?php echo WEB_NAME; ?>/Home/index.php/Index/news/pid/1" title="测试新闻测试新闻测试新闻测试新闻" class="red">测试新闻测试新闻测试新闻测试新闻</a></h1>
...
<div class="box_cent2">
     ...
     <div class="c2_ceshibiao">
          ...
          <ul class="c2_cs_ul">
                     ...
                     <a href="<?php echo WEB_NAME; ?>/Home/index.php/Index/product/pid/12"  target="_blank" class="c2li_s2">测试游戏应用五</a>
     ...
     <div class="wy_pingce">
          <div class="hd_tit">
           ...
           <ul style="border-bottom:1px dashed #efefef;">
              <div><a target="_blank" href="<?php echo WEB_NAME; ?>/Home/index.php/Index/product/pid/11"><img src="/very_cms/image/20150725/201507251026542.png"  alt=""/>测试游戏应用四</a>
              </div>
                    <li><a target="_blank" href="<?php echo WEB_NAME; ?>/Home/index.php/Index/news/pid/2" title="">测试新闻测试新闻测试..</a></li><li><a target="_blank" href="<?php echo WEB_NAME; ?>/Home/index.php/Index/news/pid/3" title="">测试新闻测试新闻测试..</a></li>
			          </ul>
           <ul>
              <div>
              </div>
     ...
     <!--二维码-->
     <!-- <div class="c1_weixin"> -->
     <div class="c1_gg"><a  href="<?php echo WEB_NAME; ?>/Home/index.php/Index/product/pid/2" target="_blank"><img src="/very_cms/adv/201507251806052.png" alt=""/></a></div>
     <!-- </div> -->
     <!--广告图-->
     <div class="c1_gg" style="margin-top:40px;"><a  href="<?php echo WEB_NAME; ?>/Home/index.php/Index/product/pid/1" target="_blank"><img src="/very_cms/adv/201507251806112.png" alt=""/></a></div>
</div>
...
<div class="box_cent4">
     ...
     <div class="c2_ceshibiao">
          ...
          <ul class="c2_phb">
            ...
            <div class="phb_top_bot1">1</div>
              ...
              <div class="phb_top_zi"><a href="<?php echo WEB_NAME; ?>/Home/index.php/Index/product/pid/5" class="hei333">测试游戏应用</a></div>
                <p class="phb_top_zi2"><a target="_blank" href="<?php echo WEB_NAME; ?>/Home/index.php/Index/product/pid/5">w</a></p>
                
            </li>
             <li class="phb_top_two"><div class="phb_top_bot1">2</div><a target="_blank" href="<?php echo WEB_NAME; ?>/Home/index.php/Index/product/pid/8">测试游戏应用一</a><span>asdf</span></li>
     ...
     <div class="wy_zixun">
          ...
          <div class="hd_pic"><a href="<?php echo WEB_NAME; ?>/Home/index.php/Index/product/pid/3" target="_blank"><img src="/very_cms/adv/201507251806152.png"   alt=""/></a></div>
          <ul class="hd_ul">
                      <li><a href="<?php echo WEB_NAME; ?>/Home/index.php/Index/news/pid/4" target="_blank">测试新闻测试新闻测试新闻测试新</a></li>
...
<div class="box_cent5">
     ...
     <ul class="game_list">
      <li><a target="_blank" href="<?php echo WEB_NAME; ?>/Home/index.php/Index/product/pid/5"><img src="/very_cms/image/20150725/201507251819492.png"</a>
            <p><a target="_blank" href="<?php echo WEB_NAME; ?>/Home/index.php/Index/product/pid/5">测试游戏应用</a></p></li><li><a target="_blank" href="<?php echo WEB_NAME; ?>/Home/index.php/Index/product/pid/8"><img src="/very_cms/image/20150725/201507251819582.png"</a>
            <p><a target="_blank" href="<?php echo WEB_NAME; ?>/Home/index.php/Index/product/pid/8">测试游戏应用一</a></p></li>
