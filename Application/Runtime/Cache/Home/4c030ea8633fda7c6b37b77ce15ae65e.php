...
<div class="box_center">
    ...
    <div class="ios_d_r">
     ...
     <div class="cent1_left">
         <div class="c1_img"><img src="/very_cms/appimage/20150731/20150731211242aa.jpg" /></div>
         <h1>第二个测试应用<span>5.5</span></h1>
         <div class="star_5"></div>
         <div class="c1_biaoqian"><span style="background-color:#cb1818;">单机</span><span>中文</span><span>否</span></div>
         <div class="c1_biaoqian2"><span>上线: 2015-07-31 21:12:42</span></div>
     ...
     <div class="left_jianjie">
         ...
         <div class="jianjie_cent">
            ...
            <p>第二个测试应用第二个测试应用第二个测试应用第二个测试应用第二个测试应用第二个测试应用第二个测试应用第二个测试应用第二个测试应用第二个测试应用第二个测试应用第二个测试应用第二个测试应用第二个测试应用第二个测试应用第二个测试应用第二个测试应用第二个测试应用第二个测试应用第二个测试应用第二个测试应用第二个测试应用第二个测试应用<img alt="aa.jpg" src="/very_cms/ueditorimage/image/20150731/1438348328124645.jpg" title="1438348328124645.jpg"/><br/></p>
        <br /></p>
         </div>
     </div>
         ...
         <div id="k_down">
               <ul>
				<li><input style="margin-top:20px;" class="a-upload" title="21" tag="http://www.youku.com"  id="down"  value="点击这里进行下载"></li>
    ...
    <div class="comm">
        ...
        <form method="post" action="<?php echo WEB_NAME; ?>/index.php/SomeAction/comment">
            ...
            <input type="hidden" value="<?php echo WEB_NAME; ?>/index.php/Index/product/pid/21" name="pageurl">
