...
<div class="box_center">
    ...
    <div class="ios_d_r">
     ...
     <div class="cent1_left">
         <div class="c1_img"><img src="" /></div>
         <h1>asdsdf<span>asd</span></h1>
         <div class="star_5"></div>
         <div class="c1_biaoqian"><span style="background-color:#cb1818;">单机</span><span>1</span><span>2</span></div>
         <div class="c1_biaoqian2"><span>上线: 0000-00-00</span></div>
     ...
     <div class="left_jianjie">
        ...
        <br /></p>
         ...
         <div class="k_down" id="k_down">
               <ul>
				<li><a href="asda" title="" class="downL-btn ml10" >点击下载</a></li>
    ...
    <div class="comm">
        <div class="game_comment" style="margin-bottom: 20px;">
            ...
            <ul id="comment_lst">
                ...
                <div style="font-size: 12px;border-bottom: 1px solid gray;margin-bottom: 5px;">
                   <div></div><div style="float:right">2015-07-31 15:33:57</div>
                    <div style="clear:both;">nihao			</div>
                </div>
                </li>
            </ul>
            <!--<div class="page"></div>-->
        ...
        <form method="post" action="<?php echo WEB_NAME; ?>/index.php/SomeAction/comment">
            ...
            <input type="hidden" value="<?php echo WEB_NAME; ?>/index.php/Index/product/pid/5" name="pageurl">
