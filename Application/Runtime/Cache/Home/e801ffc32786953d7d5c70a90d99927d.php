...
<div class="box_rank">
                              ...
                              <div class="t_tit" id="t_tit">
                                  <ul class="t_left_ul">
                                      ...
                                      <li><a href="<?php echo WEB_NAME; ?>/index.php/Index/paihang/type/android">游戏网游下载排行榜</a></li>
                                  </ul>
                              </div>
                          <div class="jietus showNow">
                                 ...
                                 <dt><a href="<?php echo WEB_NAME; ?>/index.php/Index/product/pid/5" target="_blank">asdsdf</a></dt>
                                 <dd>下载:0 </dd>
                                 <dd>0000-00-00</dd>
                              </dl>
                                 </div>
