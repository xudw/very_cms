...
<a href="<?php echo WEB_NAME; ?>/index.php/Index/appshow/type/html5"  target="_blank">html5</a>
...
<div class="and_cent1">
     ...
     <div class="c1_news">
          ...
          <div class="c1_news_t">
               ...
               <h1><a href="<?php echo WEB_NAME; ?>/index.php/Index/news/pid/7" title="">这个是子夜的头条</a></h1>
                        <p>这个是子夜的头条这个是子夜的头条这个是子夜的..
          </div>
          <ul style="border-bottom:1px dashed #e9e9e9;">
          <li><a href="<?php echo WEB_NAME; ?>/index.php/Index/news/pid/9" title="">首页的新闻首页的新闻首页的新闻首页的新闻</a></li><li><a href="<?php echo WEB_NAME; ?>/index.php/Index/news/pid/8" title="">这个是首页头条</a></li>
			          </ul>
          <ul>
    ...
    <div class="c1_banner">
     ...
     <!--二维码-->
     <div class="c1_weixin">
         <div class="zhuanji_pic"><a href="" title=""><img src="/very_cms/advimage/20150808/20150808102225aa.jpg"  title="" alt="" width="235" height="110" /></a></div>
     ...
     <div class="c1_game pic_list">
          ...
          <ul>
              <li><a href="<?php echo WEB_NAME; ?>/index.php/Index/product/pid/24" target="_blank">
                <img src="/very_cms/appimage/20150731/20150731212418aa.jpg"  title="" alt="" width="65" height="65"/></a><p><a href="" target="_blank">标签新闻1</a></p></li><li><a href="<?php echo WEB_NAME; ?>/index.php/Index/product/pid/23" target="_blank">
                <img src="/very_cms/appimage/20150731/20150731212337aa.jpg"  title="" alt="" width="65" height="65"/></a><p><a href="" target="_blank">标签游戏</a></p></li><li><a href="<?php echo WEB_NAME; ?>/index.php/Index/product/pid/21" target="_blank">
                <img src="/very_cms/appimage/20150731/20150731211242aa.jpg"  title="" alt="" width="65" height="65"/></a><p><a href="" target="_blank">第二个测试应用</a></p></li><li><a href="<?php echo WEB_NAME; ?>/index.php/Index/product/pid/20" target="_blank">
                <img src="/very_cms/appimage/20150731/20150731211032aa.jpg"  title="" alt="" width="65" height="65"/></a><p><a href="" target="_blank">一个测试应用</a></p></li>

		          </ul>
     </div>
     <!--专题--><!--预告-->
<div class="c1_yugao">
    <div class="zhuanji_pic"><a href="" title=""><img src="/very_cms/advimage/20150731/20150731212515aa.jpg"  title="" alt="" width="235" height="110" /></a></div>
         <div class="zhuanji_zi"><a href="<?php echo WEB_NAME; ?>/index.php/Index/product/pid/10" title=""></a></div><div class="zhuanji_pic"><a href="" title=""><img src="/very_cms/advimage/20150731/20150731211933aa.jpg"  title="" alt="" width="235" height="110" /></a></div>
         <div class="zhuanji_zi"><a href="<?php echo WEB_NAME; ?>/index.php/Index/product/pid/9" title=""></a></div>
...
<div class="and_cent2">
    ...
    <div class="c2_game game_list" id="gamelist">
		...
		<!-- <div class="zhu_genxin"> <div class="zhu_new">-->
		              ...
		              <li><a href="<?php echo WEB_NAME; ?>/index.php/Index/product/pid/24" title="" target="_blank">
                <img src="/very_cms/appimage/20150731/20150731212418aa.jpg" title="" target="_blank">标签新闻1</a></p><div ></div></li><li><a href="<?php echo WEB_NAME; ?>/index.php/Index/product/pid/23" title="" target="_blank">
                <img src="/very_cms/appimage/20150731/20150731212337aa.jpg" title="" target="_blank">标签游戏</a></p><div ></div></li><li><a href="<?php echo WEB_NAME; ?>/index.php/Index/product/pid/21" title="" target="_blank">
                <img src="/very_cms/appimage/20150731/20150731211242aa.jpg" title="" target="_blank">第二个测试应用</a></p><div ></div></li><li><a href="<?php echo WEB_NAME; ?>/index.php/Index/product/pid/20" title="" target="_blank">
                <img src="/very_cms/appimage/20150731/20150731211032aa.jpg" title="" target="_blank">一个测试应用</a></p><div ></div></li>
    ...
    <div class="c2_phb">
        <ul>
                ...
                <div class="phb_top_zi"><a href="<?php echo WEB_NAME; ?>/index.php/Index/product/pid/20" title="" target="_blank"  class="hei333">一个测试应用 </a></div>
                <p class="phb_top_zi2"></p>
            </li>
            <li class="phb_top_two"><div class="phb_top_bot1">2</div><a href="<?php echo WEB_NAME; ?>/index.php/Index/product/pid/21">第二个测试应用 </a><span> </span></li><li class="phb_top_two"><div class="phb_top_bot1">3</div><a href="<?php echo WEB_NAME; ?>/index.php/Index/product/pid/24">标签新闻1 </a><span> </span></li><li class="phb_top_two"><div class="phb_top_bot1">4</div><a href="<?php echo WEB_NAME; ?>/index.php/Index/product/pid/23">标签游戏 </a><span> </span></li>
...
<li><a href="<?php echo WEB_NAME; ?>/index.php/Index/product/pid/26" title="" target="_blank">
                <img src="/very_cms/appimage/20150808/20150808135234aa.jpg"  title="" alt="" width="74" height="74" /></a>
                <p><a href="<?php echo WEB_NAME; ?>/index.php/Index/product/pid/26" title="" target="_blank">地方</a></p></li>
    ...
    <div class="c2_phb">
        ...
        <li class="phb_top_one">
                ...
                <div class="phb_top_zi"><a href="<?php echo WEB_NAME; ?>/index.php/Index/product/pid/26" title="" target="_blank"  class="hei333">地方 </a></div>
                <p class="phb_top_zi2"></p>
            </li>
