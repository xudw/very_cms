...
<div class="box_center">
    ...
    <div class="ios_d_r">
     ...
     <div class="cent1_left">
         <div class="c1_img"><img src="/very_cms/appimage/20150731/20150731211032aa.jpg" /></div>
         <h1>一个测试应用<span>4.0</span></h1>
         <div class="star_5"></div>
         <div class="c1_biaoqian"><span style="background-color:#cb1818;">单机</span><span>中文</span><span>否</span></div>
         <div class="c1_biaoqian2"><span>上线: 2015-07-31 21:10:32</span></div>
     ...
     <div class="left_jianjie">
         ...
         <div class="jianjie_cent">
            ...
            <p>这是一个测试的应用这是一个测试的应用这是一个测试的应用这是一个测试的应用这是一个测试的应用这是一个测试的应用这是一个测试的应用这是一个测试的应用这是一个测试的应用这是一个测试的应用这是一个测试的应用这是一个测试的应用这是一个测试的应用这是一个测试的应用这是一个测试的应用这是一个测试的应用这是一个测试的应用这是一个测试的应用这是一个测试的应用<img alt="aa.jpg" src="/very_cms/ueditorimage/image/20150731/1438348245275403.jpg" title="1438348245275403.jpg"/></p><p><br/></p><p><br/></p>
        <br /></p>
         </div>
     </div>
         ...
         <div id="k_down">
               <ul>
				<li><input style="margin-top:20px;" class="a-upload" title="20" tag="http://www.baidu.com"  id="down"  value="点击这里进行下载"></li>
    ...
    <div class="comm">
        ...
        <form method="post" action="<?php echo WEB_NAME; ?>/index.php/SomeAction/comment">
            ...
            <input type="hidden" value="<?php echo WEB_NAME; ?>/index.php/Index/product/pid/20" name="pageurl">
