...
<div class="box_mulu">
     <ul>
         <li><span class="mulu_bg1">安卓</span>
		        <a href="<?php echo WEB_NAME; ?>/index.php/Index/product/pid/14"   target="_blank">网络呀</a><a href="<?php echo WEB_NAME; ?>/index.php/Index/product/pid/16"   target="_blank">zhege </a><a href="<?php echo WEB_NAME; ?>/index.php/Index/product/pid/10"   target="_blank">测试</a><a href="<?php echo WEB_NAME; ?>/index.php/Index/product/pid/11"   target="_blank">测试应用</a><a href="<?php echo WEB_NAME; ?>/index.php/Index/product/pid/9"   target="_blank">adfc</a><a href="<?php echo WEB_NAME; ?>/index.php/Index/product/pid/8"   target="_blank">adf</a>
				</li>
         <li><span class="mulu_bg2">苹果</span>
		         <a href="<?php echo WEB_NAME; ?>/index.php/Index/product/pid/5"   target="_blank">asdsdf</a>
				</li>
...
<div class="box_sou">
     ...
     <div class="sou_zi"><span>热门搜索</span>
         <a href="<?php echo WEB_NAME; ?>/index.php/Index/product/pid/16"   target="_blank">zhege </a><a href="<?php echo WEB_NAME; ?>/index.php/Index/product/pid/8"   target="_blank">adf</a><a href="<?php echo WEB_NAME; ?>/index.php/Index/product/pid/9"   target="_blank">adfc</a><a href="<?php echo WEB_NAME; ?>/index.php/Index/product/pid/10"   target="_blank">测试</a><a href="<?php echo WEB_NAME; ?>/index.php/Index/product/pid/11"   target="_blank">测试应用</a>
		</div>
</div>
<!--bamner -->
<div class="box_cent1">
     ...
     <div class="wy_pingce">
          <div class="hd_tit">
           ...
           <ul style="border-bottom:1px dashed #efefef;">
              <div><a target="_blank" href="<?php echo WEB_NAME; ?>/index.php/Index/product/pid/17"><img src="/very_cms/appimage/20150730/20150730180339aa.png"  alt=""/>我什么</a>
              </div>
                    <li><a target="_blank" href="<?php echo WEB_NAME; ?>/index.php/Index/news/pid/3" title="">sadf..</a></li><li><a target="_blank" href="<?php echo WEB_NAME; ?>/index.php/Index/news/pid/2" title="">assd..</a></li>
			          </ul>
           <ul>
              <div><a target="_blank" href="<?php echo WEB_NAME; ?>/index.php/Index/product/pid/18"><img src="/very_cms/appimage/20150730/20150730181206aa.png"  alt=""/>dsfg sdfgsdfg</a>
              </div>
