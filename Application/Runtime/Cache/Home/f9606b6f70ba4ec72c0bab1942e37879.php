...
<div id="main">
    ...
    <div id="right">
        ...
        <div style="margin:10px 0 0 0;float:right">
            <form action="<?php echo WEB_NAME; ?>/index.php/AppAdmins/newShow" method="post">
