    ...
    <!--<div class="shaixuan">-->
        <!--<ul>-->
            <!--<li><span>类型</span>-->
                ...
                <!--<?php if(is_array($typelist)): foreach($typelist as $key=>$tl): ?>-->
                    <!--<a href="<?php echo WEB_NAME; ?>/index.php/Index/yingyong/pid/<?php echo ($tl["type_id"]); ?>"  title="" class=""><?php echo ($tl["type_name"]); ?></a>-->
...
<div class="box_on_cent">
    ...
    <!--<div style="width:250px;float:right;">-->
        <!--<div class="c2_phb">-->
            ...
            <!--<?php if(is_array($game)): foreach($game as $key=>$g): ?>-->
            <!--<ul>-->
