...
<div class="box_center">
    ...
    <div class="ios_d_r">
     ...
     <div class="cent1_left">
         <div class="c1_img"><img src="/very_cms/appimage/20150729/20150729172717aa.png" /></div>
         <h1>dsdf <span>sadf</span></h1>
         <div class="star_5"></div>
         <div class="c1_biaoqian"><span style="background-color:#cb1818;">生活</span><span>中文</span><span>否</span></div>
         <div class="c1_biaoqian2"><span>上线: 2015-07-29</span></div>
     ...
     <div class="left_jianjie">
        ...
        <br /></p>
         ...
         <div class="k_down" id="k_down">
               <ul>
				<li><a href="sdfa" title="" class="downL-btn ml10" >点击下载</a></li>
    ...
    <div class="comm">
        ...
        <form method="post" action="<?php echo WEB_NAME; ?>/index.php/SomeAction/comment">
            ...
            <input type="hidden" value="<?php echo WEB_NAME; ?>/index.php/Index/product/pid/12" name="pageurl">
