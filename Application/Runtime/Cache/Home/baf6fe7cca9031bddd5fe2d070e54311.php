...
<div class="and_cent1">
    ...
    <div class="c1_banner">
     ...
     <div class="c1_game pic_list">
          ...
          <ul>
              <li><a href="<?php echo WEB_NAME; ?>/index.php/Index/product/pid/25" target="_blank">
                <img src="/very_cms/appimage/20150808/20150808103312aa.jpg"  title="" alt="" width="65" height="65"/></a><p><a href="" target="_blank">这个是html</a></p></li>
...
<div class="and_cent2">
    ...
    <div class="c2_game game_list" id="gamelist">
		...
		<!-- <div class="zhu_genxin"> <div class="zhu_new">-->
		              ...
		              <li><a href="<?php echo WEB_NAME; ?>/index.php/Index/product/pid/25" title="" target="_blank">
                <img src="/very_cms/appimage/20150808/20150808103312aa.jpg" title="" target="_blank">这个是html</a></p><div ></div></li>
    ...
    <div class="c2_phb">
        <ul>
                ...
                <div class="phb_top_zi"><a href="<?php echo WEB_NAME; ?>/index.php/Index/product/pid/25" title="" target="_blank"  class="hei333">这个是html </a></div>
