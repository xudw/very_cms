        ...
        <form enctype="multipart/form-data" method="post" action="<?php echo WEB_NAME; ?>/index.php/Adv/editadv">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <select name='system'>
                            <option  value='Android' <?php if($list['system']=='Android'){ ?>  selected="selected"  <?php  } ?> >Android</option>
                            <option  value='IOS' <?php if($list['system']=='IOS'){ ?>  selected="selected"  <?php  } ?> >IOS</option>
                            <option  value='WP' <?php if($list['system']=='WP'){ ?>  selected="selected"  <?php  } ?> >WP</option>
                            <option  value='HTML5' <?php if($list['system']=='HTML5'){ ?>  selected="selected"  <?php  } ?> >HTML5</option>
                        </select>
                    </td>
                </tr>
                <tr>
